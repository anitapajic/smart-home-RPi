...
def run_ds(settings, threads, stop_event, print_lock, alarm_ds, switch, ds_event, home):
    if settings['simulated']:
        dl_thread = threading.Thread(target=run_ds_simulator, args=(dl_callback, stop_event, print_lock, settings, publish_event, alarm_ds, switch, ds_event, home))
        dl_thread.start()
